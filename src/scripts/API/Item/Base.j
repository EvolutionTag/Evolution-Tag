...
library MemoryHackItemBaseAPI
    ...
    function GetItemBaseUIDataById takes integer iid returns integer
        return GetWidgetBaseUIDataById( pUnitUIDataNode, iid )
    endfunction
    ...
    function GetItemBaseUIDataByIdCaching takes integer iid returns integer
        return GetWidgetBaseDataByIdCachingEx( pUnitUIDataNode, 3, iid, 1 ) // Base Item UI Data
    endfunction
    ...
    function GetItemBaseUIStringParamById takes integer iid, integer pointerlevel, integer offset returns string
        return GetWidgetBaseUIStringParamById( pUnitUIDataNode, iid, pointerlevel, offset )
    endfunction
    
    function SetItemBaseUIStringParamById takes integer iid, integer pointerlevel, integer offset, string text returns nothing
        call SetWidgetBaseUIStringParamById( pUnitUIDataNode, iid, pointerlevel, offset, text )
    endfunction
    ...
    function GetItemBaseHotkeyById takes integer iid returns integer
        if iid > 0 then
            if GetWidgetBaseUIIntegerParamById( pUnitUIDataNode, iid, 0, 0x270 ) > 0 or GetWidgetBaseUIIntegerParamById( pUnitUIDataNode, iid, 0, 0x274 ) > 0 then
                return GetWidgetBaseUIIntegerParamById( pUnitUIDataNode, iid, 1, 0x278 )
            endif
        endif
    ...
    function SetItemBaseHotkeyById takes integer iid, integer key returns nothing
        if iid > 0 then
            call SetWidgetBaseUIIntegerParamById( pUnitUIDataNode, iid, 0, 0x270,   1 )
            call SetWidgetBaseUIIntegerParamById( pUnitUIDataNode, iid, 0, 0x274, key )
            call SetWidgetBaseUIIntegerParamById( pUnitUIDataNode, iid, 1, 0x278, key )
        endif
    endfunction
    //===========================================
