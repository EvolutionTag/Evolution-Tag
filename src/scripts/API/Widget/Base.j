...
library MemoryHackCWidgetBaseAPI
    ...
    function GetWidgetBaseDataById takes integer pDataNode, integer id returns integer
        return GetAgentBaseDataById( pDataNode, id )
    endfunction
    
    function GetWidgetBaseUIDataById takes integer pDataNode, integer id returns integer
        return GetAgentBaseUIDataById( pDataNode, id )
    endfunction

    function GetWidgetBaseData takes integer pDataNode, widget w returns integer
        return GetWidgetBaseDataById( pDataNode, GetWidgetTypeId( w ) )
    endfunction
    ...
    function GetWidgetBaseDataByIdCachingEx takes integer pDataNode, integer index, integer id, integer mode returns integer
        ...
        if id > 0 then
            ...
            elseif mode == 1 then
                set pData = GetWidgetBaseUIDataById( pDataNode, id )
            endif
    ...
    function GetWidgetBaseUIData takes integer pDataNode, widget w returns integer
        return GetWidgetBaseUIDataById( pDataNode, GetWidgetTypeId( w ) )
    endfunction

    function GetWidgetBaseUIDataByIdCaching takes integer pDataNode, integer id returns integer
        return GetWidgetBaseDataByIdCachingEx( pDataNode, 3, id, 1 ) // DEF_ADR_UNIT_UI = 3 | UI = 1
    endfunction

    function GetWidgetBaseUIDataCaching takes integer pDataNode, widget w returns integer
        return GetWidgetBaseUIDataByIdCaching( pDataNode, GetWidgetTypeId( w ) )
    endfunction
    //===========================================
    
    // Widget Base UI Data Engine
    function GetWidgetBaseUIIntegerParamById takes integer pDataNode, integer id, integer pointerlevel, integer offset returns integer
        local integer pData = 0

        if id > 0 then
            set pData = GetWidgetBaseUIDataByIdCaching( pDataNode, id )
    ...
    function SetWidgetBaseUIIntegerParamById takes integer pDataNode, integer id, integer pointerlevel, integer offset, integer val returns nothing
        local integer pData = 0
    ...
    function GetWidgetBaseUIStringParamById takes integer pDataNode, integer id, integer pointerlevel, integer offset returns string
        local integer pData = 0
    ...
    function SetWidgetBaseUIStringParamById takes integer pDataNode, integer id, integer pointerlevel, integer offset, string val returns nothing
        local integer pData = 0
