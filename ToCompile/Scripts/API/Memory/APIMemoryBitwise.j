library APIMemoryBitwise
    ...
    function Init_APIMemoryBitwise takes nothing returns nothing
        ...
        elseif PatchVersion == "1.28f" then
            ...
            set pBitwiseOR_ExecutableMemory  = pfast_call_1 + 25000
            set pBitwiseXOR_ExecutableMemory = pfast_call_1 + 26000
            set pBitwiseAND_ExecutableMemory = pfast_call_1 + 27000
        endif
    endfunction
endlibrary
